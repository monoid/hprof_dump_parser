...
pub type MemoryHprofIterator<'data, 'hprof> = StreamHprofIterator<'data, 'hprof, MainStream<Memory<'data>>, TakeStream<Memory<'data>>>;
...
where R: MainState<'stream, T> + 'stream,
      T: TakeState<'stream, R> + 'stream {
